...
1. Fund the address (ensure that your node sync process is 100%)
  ```bash
    ...
    ${testnet}
  ```
  1. if you get the following error, checkout out this [stackoverflow](https://stackoverflow.com/questions/69274218/decoderfailure-in-cardano-cli/71730916#71730916)
  ```bash
...
1. upload an image to IPFS ... say with <https://app.pinata.cloud>
   1. You will get the ipfs_hash from here
